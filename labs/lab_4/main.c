...
int main (int argc, char *argv[])
{
        ...
        float theta_out[5];     // Recalculated joint angles 

        printf("Welcome to the inverse kinematics subroutine tester.\n");
        ...
        printf("Recalculating joint angles\r\n");
        joint_angle_inv(matrix_0_5, theta_out);
        for (i = 0; i < 5; i++) {
                printf("Theta_%d = %f\r\n", i, theta_out[i]);
        }
